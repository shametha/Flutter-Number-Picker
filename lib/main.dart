...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  static const _primaryColor = Color(0xff6ED100);
  final themeElement = ThemeData.light().copyWith(
      primaryColor: _primaryColor.withRed(10),
  ...
  late String NumberFaceAssetString;
  ...
  void initState() {
    ...
    pickARandomFace = Random().nextInt(9) + 1;
    NumberFaceAssetString = 'assets/images/$pickARandomFace.png';
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: RotationTransition(
                        ...
                        child: Image.asset(NumberFaceAssetString)),
                  ),
                ),
                Padding(
